...
export default function MainContent() {
  ...
  const [globalMobili, setGlobalMobili] = useState([]);
  ...
  useEffect(() => {
    ...
    const bootstrap = async () => {
      try {
        ...
        const mobiliData = await mobiliRes.json();
        ...
        setGlobalMobili(Array.isArray(mobiliData?.mobili) ? mobiliData.mobili : []);
