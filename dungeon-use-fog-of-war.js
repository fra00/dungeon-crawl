...
export function useFogOfWar({ gameSession, staticVisibilityMap }) {
    ...
    // revealFromPoint
    // Ritorna le celle calcolate come visibili (array di {x,y,...}), in modo che
    // i caller possano fare check sincroni senza dipendere dal `fogVisibilityMap`
    // post-aggiornamento (che è async via setState).
